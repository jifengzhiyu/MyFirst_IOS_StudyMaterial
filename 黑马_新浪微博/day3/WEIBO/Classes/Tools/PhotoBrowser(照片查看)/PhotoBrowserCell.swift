    ...
    */
    ...
    var imageURL: NSURL? {
        didSet {
            ...
            imageView.sd_setImage(with: bmiddleURL(url: url) as URL, placeholderImage: nil, options: [SDWebImageOptions.retryFailed, SDWebImageOptions.refreshCached]) { current, total, _ in
    ...
    private func bmiddleURL(url: NSURL) -> NSURL {
        ...
        // 2. 替换单词
        urlString = (urlString! as NSString).replacingOccurrences(of: "/thumbnail/", with: "/bmiddle/")
